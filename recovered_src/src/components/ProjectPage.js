...
export default function ProjectPage({ projects, moduls, subModuls, sections, categories, parts, stock, setupItems, onChange, onTplChange, onPartsChange, onStockChange, onSetupItemsChange }) {
