...
export default function SubModulTemplatePage({ modul, parts, setupItems = [], onBack, onSave }) {
          ...
          <ModuleEditor
            ...
            renderCustomCell={(item, idx, key) => {
                 ...
                 return (
                     <FormulaInput 
                         value={item[key]} 
                         textAlign={textAlign}                          evaluated={evaluateFormula(item[key], [header, ...data], {}, header, 0, setupItems)}
