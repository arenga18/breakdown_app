...
rows = []
for r in range(13, 142): # Row 13 to 141 (data rows)
...
with open('/Applications/Arenga/vscode/breakdown_app/scratch/bpb_setting.json', 'w') as f:
    json.dump(rows, f, indent=2)

print(f"Dumped {len(rows)} rows to scratch/bpb_setting.json")
