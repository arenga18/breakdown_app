...
for (let r = 7; r < data.length; r++) {
  ...
  parseCell('Ket.', 'ket', false); // Col F is Ket.
  ...
  // Set default values for formula fields if not set
  if (part.lap_luar === undefined || part.lap_luar === '') part.lap_luar = part.l;
  if (part.lap_dalam === undefined || part.lap_dalam === '') part.lap_dalam = part.d;
  if (part.edg_p1 === undefined || part.edg_p1 === '') part.edg_p1 = part.p1;
  if (part.edg_p2 === undefined || part.edg_p2 === '') part.edg_p2 = part.p2;
  if (part.edg_l1 === undefined || part.edg_l1 === '') part.edg_l1 = part.l1;
  if (part.edg_l2 === undefined || part.edg_l2 === '') part.edg_l2 = part.l2;
