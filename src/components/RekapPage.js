...
export default function RekapPage({ breakdown = [], parts = [], stock = [], spec = {} }) {
  ...
  // 2. Aggregate Panels (Plywood / Boards) using Raw Board Specification
  const panelRekap = useMemo(() => {
    ...
    components.forEach(d => {
      ...
      groups[key].totalArea += d.area_m2;
    });
